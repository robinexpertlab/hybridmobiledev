System.config({
  ...
  map: {
    ...
    "npm:g11n-pipeline@1.3.0": {
      "assert": "github:jspm/nodelibs-assert@0.1.0",
      "buffer": "github:jspm/nodelibs-buffer@0.1.0",
      "crypto": "github:jspm/nodelibs-crypto@0.1.0",
      "fs": "github:jspm/nodelibs-fs@0.1.2",
      "process": "github:jspm/nodelibs-process@0.1.2",
      "swagger-client": "npm:swagger-client@2.2.21"
    },
    ...
    "npm:loopback-connector-remote@3.1.1": {
      "assert": "github:jspm/nodelibs-assert@0.1.0",
      "loopback-datasource-juggler": "npm:loopback-datasource-juggler@3.2.0",
      "process": "github:jspm/nodelibs-process@0.1.2",
      "strong-remoting": "npm:strong-remoting@3.1.1"
    },
    "npm:loopback-connector@3.0.0": {
      "assert": "github:jspm/nodelibs-assert@0.1.0",
      "async": "npm:async@1.5.2",
      ...
      "process": "github:jspm/nodelibs-process@0.1.2",
      "strong-globalize": "npm:strong-globalize@2.8.2",
      "util": "github:jspm/nodelibs-util@0.1.0"
    },
    "npm:loopback-datasource-juggler@3.2.0": {
      "assert": "github:jspm/nodelibs-assert@0.1.0",
      ...
      "events": "github:jspm/nodelibs-events@0.1.1",
      "fs": "github:jspm/nodelibs-fs@0.1.2",
      "inflection": "npm:inflection@1.12.0",
      "loopback-connector": "npm:loopback-connector@3.0.0",
      "minimatch": "npm:minimatch@3.0.3",
      "path": "github:jspm/nodelibs-path@0.1.0",
      "process": "github:jspm/nodelibs-process@0.1.2",
      "qs": "npm:qs@6.3.0",
    ...
    "npm:loopback-datatype-geopoint@1.0.0": {
      "assert": "github:jspm/nodelibs-assert@0.1.0"
    },
    "npm:loopback-phase@1.4.1": {
    ...
    "npm:loopback@3.2.1": {
      "assert": "github:jspm/nodelibs-assert@0.1.0",
      "async": "npm:async@2.1.4",
      "bcryptjs": "npm:bcryptjs@2.4.0",
      "bluebird": "npm:bluebird@3.4.7",
      "body-parser": "npm:body-parser@1.16.0",
      "buffer": "github:jspm/nodelibs-buffer@0.1.0",
      ...
      "loopback-connector-remote": "npm:loopback-connector-remote@3.1.1",
      "loopback-datasource-juggler": "npm:loopback-datasource-juggler@3.2.0",
      "loopback-phase": "npm:loopback-phase@1.4.1",
    ...
    "npm:nodemailer-stub-transport@1.1.0": {
      "buffer": "github:jspm/nodelibs-buffer@0.1.0",
      "events": "github:jspm/nodelibs-events@0.1.1",
      "systemjs-json": "github:systemjs/plugin-json@0.1.2",
      "util": "github:jspm/nodelibs-util@0.1.0"
    ...
    "npm:strong-globalize@2.8.2": {
      ...
      "fs": "github:jspm/nodelibs-fs@0.1.2",
      "g11n-pipeline": "npm:g11n-pipeline@1.3.0",
    ...
    "npm:strong-remoting@3.1.1": {
      ...
      "depd": "npm:depd@1.1.0",
      "escape-string-regexp": "npm:escape-string-regexp@1.0.5",
      "eventemitter2": "npm:eventemitter2@2.2.2",
      "events": "github:jspm/nodelibs-events@0.1.1",
      "inflection": "npm:inflection@1.12.0",
      "jayson": "npm:jayson@1.2.2",
      "loopback-datatype-geopoint": "npm:loopback-datatype-geopoint@1.0.0",
      "loopback-phase": "npm:loopback-phase@1.4.1",
